...
function upgrade_3_0_16()
{
	...
	$sql = array(
		...
		'alter table corpus_metadata_variable alter column attribute set default ""',
		'alter table corpus_metadata_variable drop key corpus',
		'alter table corpus_metadata_variable add primary key (`corpus`)',
