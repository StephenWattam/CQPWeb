...
var loading_banner = "#loadingnoJS";


$(document).ready (function() {


  /** Hide the loading//no JS banner.
   */
  $(loading_banner).fadeOut(100);

  /** Bind to any form to re-display the loading
   * banner for more seamless UI
   */
  $("form").each(function(el){
    el.onsubmit(function(){
      $(loading_banner).fadeIn();
      return true;
    });
  });
