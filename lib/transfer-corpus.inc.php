 ...
 * @file
 * 
 * This file contains functions for exportng and importing a corpus,
 ...
 * 
 * NOTE - the corpus_sql_name will be embedded in multiple places. So a corpus can only be imported under
 ...
 * @param filepath  Path of the file to import. Note that if this file exists, it will be overwritten.
 * @return          Boolean: true for success, false for failure.
 */
