...
//alert (a.cells[0].innerHTML.toLowerCase().trim() + b.cells[0].innerHTML.toLowerCase().trim() + "==");
	if (a.cells[0].innerHTML.toLowerCase().trim() < b.cells[0].innerHTML.toLowerCase().trim() ) 
		{ return -1; }
	if (a.cells[0].innerHTML.toLowerCase().trim() > b.cells[0].innerHTML.toLowerCase().trim() ) 
		{ return 1; }
	return 0;
