...
/* create && initialise global variables for c_word checking */
...
function get_element_bottom_left_corner_coords(element)
{
	...
	var x_coord = 0;
	/* we give the Y axis a "start" of its parent's height, plus "a bit" (enough to make it look right on chromium) */
	var y_coord =  element.offsetHeight + 10; //element.offsetParent.offsetHeight;
